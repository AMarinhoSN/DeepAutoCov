...
def main(options):
    ...
    for l in continent:
        ...
        sequences = read_fasta(str(options.fasta_path)) # Read the FASTA file (sequences) that contains the aminoacid sequences.
        metadata = read_csv(str(options.csv_path)) # Read the CSV file (metadata) that contains information about the sequences from the GISAID database.
